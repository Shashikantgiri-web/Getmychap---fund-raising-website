...
const Navbar = () => {
  ...
  return (
    <div className='w-[99%] h-[10vh] flex items-center justify-center bg-gray-900'>
      ...
      <div className='w-[70%] h-[99%] flex items-center justify-end'>
        <ul className='w-[99%] md:w-[80%] h-[99%] flex items-center justify-around text-white '>
          ...
          <Link href="/web_about"><li className='hover:text-purple-200 hover:text-lg transition-all duration-150 ease-in-out'>About</li></Link>
